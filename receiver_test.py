...
class receiver_test(unittest.TestCase):
    def test_update_extremes(self):
        ...
        self.assertTrue(receiver.update_extremes(receiver_test_input.meta_data_sample1, 0) == {'minimum_value': 0, 'maximum_value': 5, 'moving_avg': 0, 'moving_window': [0,0,0,0,0], 'index_of_next_item': -5})
